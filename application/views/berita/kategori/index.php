<div class="pagetitle mt-2">
	...
	<div class="row">
		<div class="col-md-12">
			<a class="btn btn-warning mb-2" href="<?= base_url('Kategori/add'); ?>">Tambah Kategori</a>
		</div>
	</div>
							...
							<tbody>
								<?php foreach ($kategori as $row) : ?>
									<tr>
										...
										<td>
											<a href="<?= site_url('Kategori/edit/' . $row->id_kategori) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
											<a href="<?= site_url('Kategori/delete/' . $row->id_kategori) ?>" class="btn btn-danger btn-sm item-delete" onclick="return confirm('Apakah Yakin Mau Dihapus')">
